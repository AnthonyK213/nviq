...
---@param iterable any[]|nviq.collections.Iterable The collection of items to remove from the `HashSet`.
...
function HashSet:__tostring()
  return require("nviq.util.collections.util").iter_inspect(self, HashSet, "HashSet")
end
