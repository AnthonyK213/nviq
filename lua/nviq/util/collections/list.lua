...
---@return nviq.collections.List slice A shallow copy of a range of elements in the source `List`.
...
---@param iterable any[]|nviq.collections.Iterable The collection whose elements should be added to the end of the `List`.
...
---predicate, and returns the one-based index of the last occurrence within the
...
---Equality test (raw).
---@param list nviq.collections.List
---@return boolean
...
function List:__tostring()
  return require("nviq.util.collections.util").iter_inspect(self, List, "List")
end
