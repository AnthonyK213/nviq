return {
  Deque          = require("nviq.util.collections.deque"),
  HashSet        = require("nviq.util.collections.hash_set"),
  Iterator       = require("nviq.util.collections.iter"),
  LinkedList     = require("nviq.util.collections.linked_list").LinkedList,
