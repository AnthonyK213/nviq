...
---@field callback? fun(proc: nviq.futures.Process, code: integer, signal: integer) Callback invoked when the process exits.
---@field protected handle? nviq.futures.ProcessHandle Process handle.
---@field is_valid boolean True if the process is valid.
---@field protected callbacks fun(proc: nviq.futures.Process, code: integer, signal: integer)[]
...
---@return fun(proc: nviq.futures.Process, code: integer, signal: integer)
...
---@param next fun(proc: nviq.futures.Process, code: integer, signal: integer)
...
function Process:write_and_wait(data)
  local task = require("nviq.util.futures.task").from_uv("write", self.stdin, data)
