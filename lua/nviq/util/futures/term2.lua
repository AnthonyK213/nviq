...
local Process = require("nviq.util.futures.proc")

local augroup = vim.api.nvim_create_augroup("nviq.futures.term2", { clear = true })

---@class nviq.futures.Terminal2 Represents a neovim terminal which implemented with lua api.
---@field protected proc nviq.futures.Process
...
---@return nviq.futures.Terminal2 self
